...
namespace MediMind.Infrastructure.Migrations
{
    ...
    [Migration("20260526194456_RelaxAppointmentDatePastCheck")]
    partial class RelaxAppointmentDatePastCheck
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MediMind.Domain.Entities.DoctorInvitation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("Token")
                        .IsUnique()
                        .HasDatabaseName("i_x_doctor_invitations_token");

                    b.HasIndex("Email", "CenterId")
                        .HasDatabaseName("i_x_doctor_invitations_email_center_id");

                    b.ToTable("doctor_invitations", (string)null);
                });
            ...
            modelBuilder.Entity("MediMind.Domain.Entities.HealthcareCenter", b =>
                {
                    ...
                    b.Property<int?>("PendingBillingCycle")
                        .HasColumnType("integer")
                        .HasColumnName("pending_billing_cycle");

                    b.Property<string>("PendingPaymentRef")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)")
                        .HasColumnName("pending_payment_ref");
                    ...
                    b.Property<bool>("RequiresPaymentBeforeConfirmation")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false)
                        .HasColumnName("requires_payment_before_confirmation");
            ...
            modelBuilder.Entity("MediMind.Domain.Entities.Payment", b =>
                {
                    ...
                    b.HasIndex("ReasonType")
                        .HasDatabaseName("i_x_payments_reason_type");
            ...
            modelBuilder.Entity("MediMind.Domain.Entities.PlatformConfiguration", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<decimal>("BasicFeeEtb")
                        .HasColumnType("numeric(18,2)")
                        .HasColumnName("basic_fee_etb");
                    ...
                    b.Property<int>("MaxSlotDurationMinutes")
                        .HasColumnType("integer")
                        .HasColumnName("max_slot_duration_minutes");

                    b.Property<decimal>("PremiumFeeEtb")
                        .HasColumnType("numeric(18,2)")
                        .HasColumnName("premium_fee_etb");

                    b.Property<decimal>("TrialFeeEtb")
                        .HasColumnType("numeric(18,2)")
                        .HasColumnName("trial_fee_etb");
            ...
            modelBuilder.Entity("MediMind.Domain.Entities.ScheduleException", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("DoctorId", "CenterId", "ExceptionDate")
                        .IsUnique()
                        .HasDatabaseName("i_x_schedule_exceptions_doctor_id_center_id_exception_date");
            ...
            modelBuilder.Entity("MediMind.Domain.Entities.WaitlistSubscription", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("CenterId")
                        .HasDatabaseName("i_x_waitlist_subscriptions_center_id");

                    b.HasIndex("DoctorId", "CenterId", "IsActive")
                        .HasDatabaseName("i_x_waitlist_subscriptions_doctor_id_center_id_is_active");

                    b.HasIndex("PatientId", "DoctorId", "CenterId")
                        .HasDatabaseName("i_x_waitlist_subscriptions_patient_id_doctor_id_center_id");

                    b.ToTable("waitlist_subscriptions", (string)null);
                });
            ...
            modelBuilder.Entity("MediMind.Domain.Entities.WaitlistSubscription", b =>
                {
                    b.HasOne("MediMind.Domain.Entities.HealthcareCenter", "Center")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("f_k_waitlist_subscriptions_healthcare_centers_center_id");
                    ...
                    b.HasOne("MediMind.Domain.Entities.Doctor", "Doctor")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("f_k_waitlist_subscriptions_doctors_doctor_id");
                    ...
                    b.HasOne("MediMind.Domain.Entities.Patient", "Patient")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("f_k_waitlist_subscriptions_patients_patient_id");
